...
- [準備](#%E6%BA%96%E5%82%99)
  ...
  - [組み立て工程全体の確認](#%E7%B5%84%E3%81%BF%E7%AB%8B%E3%81%A6%E5%B7%A5%E7%A8%8B%E5%85%A8%E4%BD%93%E3%81%AE%E7%A2%BA%E8%AA%8D)
...
- [ファームウェアを書き込む](#%E3%83%95%E3%82%A1%E3%83%BC%E3%83%A0%E3%82%A6%E3%82%A7%E3%82%A2%E3%82%92%E6%9B%B8%E3%81%8D%E8%BE%BC%E3%82%80)
  - [Remap(VIA) 対応ファームウェアを仕様する場合](#remapvia-%E5%AF%BE%E5%BF%9C%E3%83%95%E3%82%A1%E3%83%BC%E3%83%A0%E3%82%A6%E3%82%A7%E3%82%A2%E3%82%92%E4%BB%95%E6%A7%98%E3%81%99%E3%82%8B%E5%A0%B4%E5%90%88)
  - [OLEDを使用する場合 (あるいは、こだわり派/分かってる人向け情報)](#oled%E3%82%92%E4%BD%BF%E7%94%A8%E3%81%99%E3%82%8B%E5%A0%B4%E5%90%88-%E3%81%82%E3%82%8B%E3%81%84%E3%81%AF%E3%81%93%E3%81%A0%E3%82%8F%E3%82%8A%E6%B4%BE%E5%88%86%E3%81%8B%E3%81%A3%E3%81%A6%E3%82%8B%E4%BA%BA%E5%90%91%E3%81%91%E6%83%85%E5%A0%B1)
- [ハードウェアの組み立て](#%E3%83%8F%E3%83%BC%E3%83%89%E3%82%A6%E3%82%A7%E3%82%A2%E3%81%AE%E7%B5%84%E3%81%BF%E7%AB%8B%E3%81%A6)
  ...
  - [(オプション) バックライト/アンダーグロウ LED の取り付け](#%E3%82%AA%E3%83%97%E3%82%B7%E3%83%A7%E3%83%B3-%E3%83%90%E3%83%83%E3%82%AF%E3%83%A9%E3%82%A4%E3%83%88%E3%82%A2%E3%83%B3%E3%83%80%E3%83%BC%E3%82%B0%E3%83%AD%E3%82%A6-led-%E3%81%AE%E5%8F%96%E3%82%8A%E4%BB%98%E3%81%91)
    - [LED の動作確認方法](#led-%E3%81%AE%E5%8B%95%E4%BD%9C%E7%A2%BA%E8%AA%8D%E6%96%B9%E6%B3%95)
  ...
  - [動作確認](#%E5%8B%95%E4%BD%9C%E7%A2%BA%E8%AA%8D)
    ...
    - [(OLEDを使用する場合) OLED の動作確認](#oled%E3%82%92%E4%BD%BF%E7%94%A8%E3%81%99%E3%82%8B%E5%A0%B4%E5%90%88-oled-%E3%81%AE%E5%8B%95%E4%BD%9C%E7%A2%BA%E8%AA%8D)
...
- [カスタマイズする](#%E3%82%AB%E3%82%B9%E3%82%BF%E3%83%9E%E3%82%A4%E3%82%BA%E3%81%99%E3%82%8B)
  - [キーマップのカスタマイズ](#%E3%82%AD%E3%83%BC%E3%83%9E%E3%83%83%E3%83%97%E3%81%AE%E3%82%AB%E3%82%B9%E3%82%BF%E3%83%9E%E3%82%A4%E3%82%BA)
    - [Remap を使用しない場合](#remap-%E3%82%92%E4%BD%BF%E7%94%A8%E3%81%97%E3%81%AA%E3%81%84%E5%A0%B4%E5%90%88)
...
- **Pro Micro(コンスルー付き) ... 2組**
   ...
   - Type-C 版や BLE 対応版などのバリエーションもあります。私は試したことないですが、多分動くと思います。
- MX 互換スイッチ ... 42個
   - おすすめ購入先
...
- TRSケーブル ... 1本
    ...
    - elephant42 が必要とするのは 3 極(黒線が2本入るタイプ)の TRS ケーブルですが、自作キーボードショップなどでよく売られている 4 極(黒線が3本入るタイプ) の TRRS ケーブルでも代用可能です。
      - [TRRSケーブル | Daily Craft Keyboard](https://shop.dailycraft.jp/products/trrs_cable_50)
...
- USB ケーブル (Type-A to Micro-B) ... 1本
    ...
    - Type-C 版 ProMicro など、Micro-Bを使用しない Pro Micro を使う場合は適切なケーブルを調達してください。
...
1. SK6812MINI-E ... 54個
    - [SK6812MINI-E（10個入り） | 遊舎工房](https://shop.yushakobo.jp/collections/all-products/products/sk6812mini-e-10) ※6パック購入してください(6個余ります)
    ...
    - [マイコン内蔵RGBLED SK6812MINI-E(5個入): LED(発光ダイオード) 秋月電子通商-電子部品・ネット通販](https://akizukidenshi.com/catalog/g/gI-15478/) ※11パック購入してください(1個余ります  )
...
- はんだ
  - [goot 高密度集積基板用はんだ SD-60](https://www.amazon.co.jp//dp/B0029LGAJI/)
    - ほとんどの部品はこちらで取り付けています。正直なんでも良いです。
  - [久富電機産業 SH-43 低温はんだ](https://www.sengoku.co.jp/mod/sgk_cart/detail.php?code=6A2W-CFJP)
    - LED(SK6812mini-E) だけは高温で壊れる危険性があるため、念のためこちらを使っています
- はんだ吸い取り線
  - [goot はんだ吸取り線 CP-3015](https://www.amazon.co.jp/dp/B001PR1KPQ)
  - [はんだシュッ太郎](https://www.sunhayato.co.jp/material2/jtp03/item_1054)などがあればそれに越したことはないんでしょうけど試せたことがないです。
- はんだこて
  - [白光 ダイヤル式温度制御はんだこて FX600](https://www.amazon.co.jp/dp/B006MQD7M4)
  - **温度調整機能つきを強くおすすめします。** 私は温度調節機能なしのこてで成功できた試しがありません。
- こて台
...
※ 動画が作成された当時と今現在のビルドガイドで組み立て工程に若干の違い(主にファームウェアまわり。すっごく便利になりました。)があります。混乱しないように！
...
さっそくはんだ付けをしたい！というはやる気持ちをグッとこらえて、まずは Pro Micro にファームウェアを書き込みます。

## Remap(VIA) 対応ファームウェアを仕様する場合

ここ最近、 Remap という非常に便利でオープンなサービスが開始され、とっても便利かつ簡単に自作キーボードを設定できるようになったので**強くオススメ**しています。

Google Chrome ブラウザより、 Remap キーボードカタログの [elephant42 ファームウェア書き込みページ](https://remap-keys.app/catalog/qAHXTqZmXu6Cd6K7jqcD/firmware) にアクセスします。

***※現在、Remap は Google Chrome または Microsoft Edge 以外のブラウザではうまく動かすことができないそうです。***

ここで、PC に Micro USB ケーブルを接続し、さらに Pro Micro を接続します。

elephant42_via.hex の下のほうにある `FLASH` をクリックします。ファームウェアの書き込み方法についての説明画面がでるので、その説明通りさらに `FLASH` をクリックします。

`remap-keys.app がシリアルポートへの接続を要求しています` という選択画面がでてくるので、RST と GND を一瞬ショートさせて Pro Micro を書き込み待機状態とさせます。
すると先ほどの選択画面に `Arduino Micro` という項目が出現するので、それを選択して接続ボタンをクリックします。

選択画面が消え、元の画面で処理が続行されます。最後に `Writing the firmware finished successfully.` とメッセージがでたら成功！ `CLOSE` をクリックして書き込みを終了します。

| ![connect](build-guide/promicro_connect.jpeg) | ![remap](build-guide/remap-write1.jpeg) |
|--|--|
| PC に ProMicro を接続する | `FLASH`すると、選択画面がでてくる |
| ![firmware](build-guide/promicro_reset.jpeg) | ![remap](build-guide/remap-write2.jpeg)|
| RST と GND を一瞬ショートさせて書き込み待機モードにする | 選択画面に、`Arduino Micro` がでてくるので、それを選択して接続 |

これを左右両方ぶんの Pro Micro 2 つに対して実施します。完了したら、Remap との接続確認をしましょう。

[Remapのトップページ(https://remap-keys.app/)](https://remap-keys.app/) に飛び、`START REMAP FOR YOUR KEYBOARD` をクリックします。

さらに `+ KEYBOARD` をクリックすると、キーボードの接続ウィンドウがでます。そこで `elephant42` が出れば成功です！選択し、接続すると elephant42 のキーマップを編集したり、
LED の光りかたをいじったりできるのですが、今は Pro Micro に何もつながっていないので弄りようがありません。

USB ケーブルを抜くと元の画面に戻るので、両方の Pro Micro が正しくファームウェアを書き込めているか確認します。

うまくいかないときは、これまでの工程を注意深く確認しながらやり直してみてください。


## OLEDを使用する場合 (あるいは、こだわり派/分かってる人向け情報)

OLED を使用する場合、また Remap(VIA) 版で対応していない機能 (主にQMKの最新機能など) を使いたい場合は、
非常に残念ながら Pro Micro の容量の問題から 上記の方法ではうまくいきません。
自分で QMK Firmware のソースコードをビルドし、Pro Micro に書き込む必要があります。

**また、この方法で書き込まれたファームウェアは、Remap からキーマップの変更やLEDの操作ができません。基本的にすべてソースコードを弄ってはビルドし直す、という手順となります。**


プログラミング経験がある方なら難なくできる程度、そうでなくてもドキュメントは揃っているので頑張ってみれば案外どうにかなっちゃう程度の難易度ですが、
**黒い画面に白い文字で英語がズラっと並ぶ、よく映画でハッカーとかが見てるみたいな画面を見るハメになる** ので自信がない人は OLED を諦めたほうがいいかもしれません。

ただ、個人的には **OLED すごく力作だし、ちょっと前の自作キーボード界隈では誰もが普通にやっていた事ですし、なにより上手くいったときの喜びはひとしおですので、
食わず嫌いせずぜひトライしてみて欲しい** です。
私に連絡いただければ出来る限るのサポートもさせていただきますよ!!

ということで、まずはファームウェアのビルド環境を整えます。

https://docs.qmk.fm/#/ja/newbs_getting_started

をよく読み、お使いのPCに環境を構築します。

うまくいったら、`https://github.com/illness072/elephant42-firmware/releases` にあるソースコードをダウンロード&展開し、
QMK がダウンロードされたディレクトリの `keyboards/` の下に `elephant42` というディレクトリを作成して、そこに中身をコピーします。

つまり、 `<QMKの場所>/keyboards/elephant42/` に `README.md` や `elephant42.c` があるようになります。

git を使える人は、上記リポジトリを `keyboards/elephant42` 以下で git clone すると以降で更新がラクになります。

最後に `qmk` コマンドでビルド&書き込みします。

```
$ qmk flash -kb elephant42 -km default
```
...
なお、一部の環境では、コマンド実行時に以下のようなメッセージが出ることがあります。このときはそのまま Enter を押してしばらく待ち、書き込みが失敗して終わるのを待ちます。
...
```
sudo qmk flash -kb elephant42 -km default
```
...
すべての LED が同時に 「赤→緑→青→赤→...」と順番に点灯する `RGB Test` モードで LED を光らせることにより、はんだ付けした LED が無事に動いてるかどうかを確認できます。

Remap に接続し、elephant42 設定画面の右側、Lighting(太陽みたいなアイコン) をクリックして LED の操作画面を開きます。 `Effect Mode` を `RGB Test` にします。

消灯したい場合は `All Off` にすると消えます。
...
また OLED を使用する場合など、Remap(VIA) 対応ファームを使用しない場合でも、一時的に Remap(VIA) 対応ファームを焼いて 上記通りに確認するのが一番てっとり早いです。
後の工程で実施するキーマトリクスの動作確認まで含めて Remap(VIA) 対応ファームで実施することをおすすめしています。
...
elephant42 に使用されている SK6812MINI-E でなく、その改良前版の SK6812MINI についての記事ですが、
...
SK6812MINI-E のピンアサインは以下の通りなので、SK6812MINI のそれとは異なります。適宜読み替えてください。
...
Remap に接続し、elephant42 設定画面の右下側、 … のアイコンをクリックしたメニューのなかから `Test Matrix mode` をクリックします。

Test Matrix mode では押されたキーが青く変化します。ぜんぶのキーについて動作確認(つまり表示されているキーがすべて青くなる)できれば完了です！

対象のキーについて一時的にソケットにキースイッチを刺して押してみるか、ピンセットでソケットの両端を触ることで確認をしていきます。

| ![ProMicroを取り付ける](build-guide/test_start.jpeg) | ![スイッチソケットをショートする](build-guide/test_short.jpeg) |
|:--:|:--:|
| 表側から ProMicro を取り付け、全てのケーブルを接続し、再度ファームウェアを焼きます。<br/>OLEDを取り付ける場合は、OLEDも取り付けますが、Remap(VIA)版ファームなのでこの時点では点灯しません。 | 任意のキーソケットをショートさせ、該当するキーが押されたように振る舞うかを確認する。**裏側から触っていることになるため、左右逆になります。** |
| ![動作確認](build-guide/remap-test1.jpeg) | ![デフォルトキーマップ(右)](build-guide/remap-test2.jpeg) |
| 各キーについて動作確認をしていきます・・・ | すべて青くなれば完了！　**おめでとう！！** |
...
### (OLEDを使用する場合) OLED の動作確認

さて、OLEDファームウェアを書き込みし直して OLED が光るかを確認しましょう!!

右手側に elephant42 ロゴ、左手側にレイヤー表示とキー入力するたびにちょこちょこ動く 🐘 のアイコンが映れば OK!!

動かない場合はファームウェアの書き込み不良かはんだ不良が考えられます。再度確認しましょう!
...
| トッププレートにスペーサー(短)をねじ留めします。<br/>**指紋がつかないよう注意!!** | その上からミドルプレートを乗せます。<br/>**ホコリを挟みこまないよう注意!!** |
...
Remap に接続し、あなただけのキーマップを作り込んでいきましょう!!
...
elephant42 専用の [光るパームレスト一体型ケース](https://github.com/illness072/elephant42/tree/master/cases/) もあわせて開発中です。
...
問題なく動作しているのであれば、実際定期的なファームウェアアップデートはあまり必要ないですが、QMK の新機能を試したい時などはやってみるのも良いかもしれません。

また、 elephant42 のファームウェアとしても、たまに気分次第でアップデートをかけています。興味のある方はぜひ。
